...
* 
* Programa: Inclusao de Disciplina e Pre-requisitos em Malha
* 
* */
...
/*
 * Estrutura lista de pre-requistos
 * 
 * */
	...
	do {
		...
		if (!arq)
			...
			*epinicio = NULL;
			...
			// controi lista de pre-requisitos para a respectiva disciplina
			while ((c = getc (arq)) != EOF) {
...
void PercorreMalha(lista1 *pinicio) {
	...
	if (pinicio == NULL)
		...
		printf("DISCIPLINA | PRE-REQUISITOS\n");
		while (pd1 != NULL) {
